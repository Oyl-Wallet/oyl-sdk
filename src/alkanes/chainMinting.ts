...
export const DUST_LIMITS = {
  [AddressType.P2WPKH]: 294,    // Native SegWit最低阈值
  [AddressType.P2TR]: 330,      // Taproot最低阈值
  [AddressType.P2SH_P2WPKH]: 540, // Nested SegWit最低阈值
 ...
 * RBF配置常量
 */
export const RBF_CONFIG = {
  ENABLED_SEQUENCE: 0xfffffffd,   // 启用RBF的nSequence值
 ...
 * 标准vout布局定义
 */
export enum StandardVoutLayout {
  /** 接力/燃料输出 - 承载资产和剩余sats */
  RELAY_OUTPUT = 0,
 ...
 * 链式铸造错误类型
 */
export enum ChainMintingErrorType {
 ...
 * 链式铸造错误类
 */
export class ChainMintingError extends Error {
  constructor(
    public type: ChainMintingErrorType,
    message: string,
    public details?: any
  ) {
    super(message)
...
export const DEFAULT_EXECUTION_PARAMS = {
  ...
  broadcastConfig: DEFAULT_BROADCAST_CONFIG
}
...
export { 
  ...
  calculateActualTransactionFees,
  compareFeeCalculations,
  formatFeeCalculationResult,
...
export {
  ...
  formatChildChainResult,
  generateChildChainSummary
