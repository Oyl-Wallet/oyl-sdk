...
export const alkaneCreatePool = new AlkanesCommand('create-pool')
  ...
  .action(async (options) => {
    ...
    calldata.push(BigInt(options.tokens[0].split(':')[1]))
    calldata.push(BigInt(options.tokens[1].split(':')[0]))
    calldata.push(BigInt(options.tokens[1].split(':')[1]))
    calldata.push(BigInt(options.tokens[0].split(':')[2]))
    calldata.push(BigInt(options.tokens[1].split(':')[2]))
