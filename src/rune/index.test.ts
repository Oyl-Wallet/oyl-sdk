...
describe('rune txs', () => {
  it('rune send tx', async () => {
    ...
    expect(psbt).toEqual(
      ''
    )
  })
  ...
  it('rune mint tx', async () => {
    ...
    expect(psbt).toEqual(
      ''
    )
  })
  ...
  it('rune etch commit', async () => {
    ...
    expect(psbt).toEqual(
      'cHNidP8BAH0CAAAAAXSylcOFQbI1nskmceQS35wMCSdXaqjQywF8WPolLuJyAAAAAAD/////As4JAAAAAAAAIlEgAQJDmRbEnUdH5/iwTc+V3fGETzdxZKTn28wyvFNpHMhOdAEAAAAAABYAFMDOvNbD08qMddxexi6+VTMO+RDiAAAAAAABAR+ghgEAAAAAABYAFMDOvNbD08qMddxexi6+VTMO+RDiAAAA'
    )
  })
