...
exports.allAssetsBalance = exports.accountBRC20Balance = exports.addressUtxosToSpend = exports.addressBRC20Balance = exports.accountAvailableBalance = exports.accountUtxosToSpend = void 0;
...
exports.accountAvailableBalance = new commander_1.Command('balance')
    ...
    .requiredOption('-p, --provider <provider>', 'Network provider type (regtest, bitcoin)')
    .option('-d, --detailed', 'Show detailed balance breakdown by address type')
    /* @dev example call
    ...
    */
    ...
    if (options.detailed) {
        ...
        const addresses = [
            { type: 'Taproot', key: 'taproot', address: wallet.account.taproot.address },
            { type: 'Native SegWit', key: 'nativeSegwit', address: wallet.account.nativeSegwit.address },
            { type: 'Nested SegWit', key: 'nestedSegwit', address: wallet.account.nestedSegwit.address },
            { type: 'Legacy', key: 'legacy', address: wallet.account.legacy.address },
        ];
...
exports.accountBRC20Balance = new commander_1.Command('accountBRC20Balance')
...
exports.allAssetsBalance = new commander_1.Command('allAssets')
