...
async function buildChildTransaction(config) {
    const { parentTxId, parentVoutIndex = 0, parentOutputValue, transactionIndex, isLastTransaction, finalReceiverAddress, wallets, contractId, childTxFee, provider } = config;
    try {
