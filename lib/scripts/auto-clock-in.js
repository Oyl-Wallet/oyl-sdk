...
class AutoClockInService {
    ...
    loadConfig() {
        ...
        return {
            ...
            initialFeeMultiplier: parseFloat(process.env.INITIAL_FEE_MULTIPLIER || '1.0'),
            accelerateFeeMultiplier: parseFloat(process.env.ACCELERATE_FEE_MULTIPLIER || '1.0'),
            maxFeeIncrease: parseInt(process.env.MAX_FEE_INCREASE || '50'),
    ...
    async accelerateTransactionsIfNeeded(currentFeeInfo) {
