...
const auto_clock_in_1 = require("./auto-clock-in");
...
describe('AutoClockInService', () => {
    ...
    describe('Wallet Initialization', () => {
        it('should create unique wallets with different signers and addresses', () => {
            const service = new auto_clock_in_1.AutoClockInService();
            // Access private wallets property for testing
            const wallets = service.wallets;
            ...
            const signers = wallets.map((wallet) => wallet.signer);
        ...
        it('should create signers with correct private keys for each wallet index', () => {
            ...
            const taprootPublicKeys = wallets.map((wallet) => wallet.signer.taprootKeyPair.publicKey.toString('hex'));
            ...
            const expectedPrivateKeys0 = (0, src_1.getWalletPrivateKeys)({
            ...
            const expectedSigner = new src_1.Signer(bitcoin.networks.regtest, {
    ...
    describe('Transaction Execution', () => {
        it('should call alkanes.execute with required alkaneReceiverAddress for each wallet', async () => {
            ...
            const executeClockIn = service.executeClockIn.bind(service);
            const wallets = service.wallets;
            ...
            expect(alkanes.execute).toHaveBeenCalledWith(expect.objectContaining({
        ...
        it('should use each wallet\'s own address as receiver', async () => {
            ...
            const calls = alkanes.execute.mock.calls;
        ...
        it('should get unique UTXOs for each wallet', async () => {
            ...
            const utxoCalls = utxo.accountUtxos.mock.calls;
    ...
    describe('Concurrent Execution', () => {
        it('should execute clock-in for all wallets concurrently with different receivers', async () => {
            const service = new auto_clock_in_1.AutoClockInService();
            const sendClockInTransactions = service.sendClockInTransactions.bind(service);
    ...
    describe('Configuration Validation', () => {
        it('should throw error when CLOCK_IN_MNEMONIC is not set', () => {
            ...
            expect(() => new auto_clock_in_1.AutoClockInService()).toThrow('CLOCK_IN_MNEMONIC not found in environment variables');
        });
...
//# sourceMappingURL=auto-clock-in.test.js.map